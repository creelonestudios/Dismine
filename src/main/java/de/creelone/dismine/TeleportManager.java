...
public class TeleportManager {
	...
	public static void initTables() {
		...
		Dismine.instance.sql.update("CREATE TABLE IF NOT EXISTS warps (name VARCHAR(255), world VARCHAR(255), x DOUBLE, y DOUBLE, z DOUBLE, yaw FLOAT, pitch FLOAT)");
		Dismine.instance.sql.update("CREATE TABLE IF NOT EXISTS homes (owner VARCHAR(255), name VARCHAR(255), world VARCHAR(255), x DOUBLE, y DOUBLE, z DOUBLE, yaw FLOAT, pitch FLOAT)");
	}
